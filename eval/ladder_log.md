...
| 2026-08-08 | `v25.tar.gz` | **Rule-Based Lucario v25 (Ladder Audit)** | Mega Lucario | ~600 average | 19-21 across 40 unique replays | Pure Alakazam 1-8; non-Alakazam 18-13. Found wrong-hand Powerful Hand modeling, a terminal attack tie, rigid evolution, three deck-out/stall losses, and redundant Hariyama charging. |
| 2026-08-08 | `v26.tar.gz` | **Rule-Based Lucario v26 (Bronze Push)** | Mega Lucario | Submitted; awaiting stable result | 41 replay regressions + cabt gauntlet | Later card-text audit found Powerful Hand perspective was reversed; retain only as a live comparison. |
| 2026-08-08 | `v27.tar.gz` | **Rule-Based Lucario v27 (Hand Trimmer Meta Build)** | Mega Lucario + 4 Hand Trimmer | *Not submitted* | 45 regressions; Alakazam 30-30 over 60; original-Lucario comparison 19-21 | Correct Powerful Hand model; Hand Trimmer is gated to Alakazam/Froslass. The 7-8 v26 follow-up added overcharge prevention and no-safe-pivot last-chance attacks. |
...
| 2026-08-08 | `v29.tar.gz` | **Rule-Based Lucario v29 (Broken)** | Mega Lucario | **ERROR/REGRESSED** | 44% vs v29 | Reconstructed from bad archive, missing v27/v28 tempo logic. Replaced immediately. |
| 2026-08-08 | `v30.tar.gz` | **Rule-Based Lucario v30 (Definitive)** | Mega Lucario | *Pending Ladder Upload* | 97.1% (602-18) | Restored v28 base + Spikemuth/Snorlax/Archaludon meta fixes + Aura Jab engine bypass + Hand Trimmer fixes. Passed 600-game Top 20 gauntlet with 0 crashes. |
