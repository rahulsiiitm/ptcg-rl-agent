...
this sample code is given i the discussions can we use this
</USER_REQUEST>
<ADDITIONAL_METADATA>
The current local time is: 2026-08-05T18:41:36+05:30.

The user's current state is as follows:
Active Document: d:\Projects\4th Year\ptcg-rl-agent\scripts\dump_state.py (LANGUAGE_PYTHON)
Cursor is on line: 1
Other open documents:
- d:\Projects\4th Year\ptcg-rl-agent\src\agent\rule_based_lucario.py (LANGUAGE_PYTHON)
- d:\Projects\4th Year\ptcg-rl-agent\scripts\dump_state.py (LANGUAGE_PYTHON)
</ADDITIONAL_METADATA>